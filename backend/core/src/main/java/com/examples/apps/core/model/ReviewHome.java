 ...
 * @see com.examples.apps.core.model.Review
...
public class ReviewHome {
	...
	public Review merge(Review detachedInstance) {
		...
		try {
			Review result = (Review) sessionFactory.getCurrentSession().merge(
					detachedInstance);
	...
	public Review findById(java.lang.String id) {
		...
		try {
			Review instance = (Review) sessionFactory.getCurrentSession().get(
					"com.examples.apps.core.model.Review", id);
			if (instance == null) {
	...
	public List findByExample(Review instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("com.examples.apps.core.model.Review")
